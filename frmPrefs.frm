   ...
   Begin VB.Frame fraDevelopment 
      ...
      Begin VB.Frame fraDevelopmentInner 
         ...
         Begin VB.ComboBox cmbDebug 
            Height          =   315
            ItemData        =   "frmPrefs.frx":8431
            Left            =   1530
            List            =   "frmPrefs.frx":8433
            Style           =   2  'Dropdown List
            TabIndex        =   46
   ...
   Begin VB.Frame fraGeneral 
      ...
      Begin VB.Frame fraGeneralInner 
         ...
         Begin VB.CheckBox chkGenStartup 
            Caption         =   "Run the Sun Widget at Windows Startup "
            Height          =   465
            Left            =   1995
            TabIndex        =   159
            ToolTipText     =   "Check this box to enable the automatic start of the program when Windows is started."
...
Private Sub optWidgetTooltips_Click(Index As Integer)
    ...
    If pvtPrefsStartupFlg = False Then
        ...
        sPutINISetting "Software\Sun", "widgetTooltips", gblWidgetTooltips, gblSettingsFile
...
Private Sub optPrefsTooltips_Click(Index As Integer)
   ...
   On Error GoTo optPrefsTooltips_Click_Error
    ...
    If pvtPrefsStartupFlg = False Then
        ...
        sPutINISetting "Software\Sun", "prefsTooltips", gblPrefsTooltips, gblSettingsFile
   ...
   On Error GoTo cmbMultiMonitorResize_Click_Error
    ...
    If cmbMultiMonitorResize.ListIndex = 2 Then
        If prefsMonitorStruct.IsPrimary = True Then
            gblWidgetPrimaryHeightRatio = fMain.SunForm.WidgetRoot.Zoom
            sPutINISetting "Software\Sun", "widgetPrimaryHeightRatio", gblWidgetPrimaryHeightRatio, gblSettingsFile
            
            'gblPrefsPrimaryHeightTwips = Trim$(cstr(widgetPrefs.Height))
            sPutINISetting "Software\Sun", "prefsPrimaryHeightTwips", gblPrefsPrimaryHeightTwips, gblSettingsFile
        Else
            gblWidgetSecondaryHeightRatio = fMain.SunForm.WidgetRoot.Zoom
            sPutINISetting "Software\Sun", "widgetSecondaryHeightRatio", gblWidgetSecondaryHeightRatio, gblSettingsFile
            
            'gblPrefsSecondaryHeightTwips = Trim$(cstr(widgetPrefs.Height))
            sPutINISetting "Software\Sun", "prefsSecondaryHeightTwips", gblPrefsSecondaryHeightTwips, gblSettingsFile
        End If
    End If
...
Private Sub Form_Load()
    ...
    Me.mnuAbout.Caption = "About Sun Widget Cairo" & gblRichClientEnvironment & " Cairo " & gblCodingEnvironment & " widget"
...
Public Sub positionPrefsMonitor()
    ...
    If formLeftTwips = 0 Then
        If ((fMain.SunForm.Left + fMain.SunForm.Width) * gblScreenTwipsPerPixelX) + 200 + widgetPrefs.Width > gblPhysicalScreenWidthTwips Then
            widgetPrefs.Left = (fMain.SunForm.Left * gblScreenTwipsPerPixelX) - (widgetPrefs.Width + 200)
        End If
    End If
    ...
    If gblMonitorCount > 1 And LTrim$(gblMultiMonitorResize) = "2" Then
        ...
        If prefsMonitorStruct.IsPrimary = True Then
            gblPrefsFormResizedInCode = True
            gblPrefsPrimaryHeightTwips = fGetINISetting("Software\Sun", "prefsPrimaryHeightTwips", gblSettingsFile)
            ...
            End If
        Else
            gblPrefsSecondaryHeightTwips = fGetINISetting("Software\Sun", "prefsSecondaryHeightTwips", gblSettingsFile)
            gblPrefsFormResizedInCode = True
    ...
    '' SunWidget.RotateBusyTimer = True
...
Private Sub chkDpiAwareness_Click()
    ...
    If pvtPrefsStartupFlg = False Then ' don't run this on startup
        ...
        sPutINISetting "Software\Sun", "dpiAwareness", gblDpiAwareness, gblSettingsFile
...
Private Sub chkPreventDragging_Click()
    ...
    If chkPreventDragging.Value = 0 Then
        ...
        End If
    Else
        SunWidget.Locked = True
        gblPreventDragging = "1"
        menuForm.mnuLockWidget.Checked = True
        If gblAspectRatio = "landscape" Then
            txtLandscapeHoffset.Text = fMain.SunForm.Left
            txtLandscapeVoffset.Text = fMain.SunForm.Top
        Else
            txtPortraitHoffset.Text = fMain.SunForm.Left
            txtPortraitYoffset.Text = fMain.SunForm.Top
        End If
    End If
...
Private Sub chkWidgetHidden_Click()
   On Error GoTo chkWidgetHidden_Click_Error
    ...
    If chkWidgetHidden.Value = 0 Then
        'SunWidget.Hidden = False
        fMain.SunForm.Visible = True

        frmTimer.revealWidgetTimer.Enabled = False
        gblWidgetHidden = "0"
    Else
        'SunWidget.Hidden = True
    ...
    sPutINISetting "Software\Sun", "widgetHidden", gblWidgetHidden, gblSettingsFile
...
Private Sub cmbDebug_Click()
    ...
    If cmbDebug.ListIndex = 0 Then
        txtDefaultEditor.Text = "eg. E:\vb6\Sun-" & gblRichClientEnvironment & "-Widget-VB6MkII\Sun-" & gblRichClientEnvironment & "-Widget-" & gblCodingEnvironment & ".vbp"
...
Private Sub cmbScrollWheelDirection_Click()
   On Error GoTo cmbScrollWheelDirection_Click_Error
    ...
    btnSave.Enabled = True ' enable the save button
    'SunWidget.ZoomDirection = cmbScrollWheelDirection.List(cmbScrollWheelDirection.ListIndex)
...
'    End If
    ...
    If gblStartup = "1" Then
        Call writeRegistry(HKEY_CURRENT_USER, "SOFTWARE\Microsoft\Windows\CurrentVersion\Run", "Sun" & gblRichClientEnvironment & "Widget" & gblCodingEnvironment, """" & App.Path & "\" & "Sun-" & gblRichClientEnvironment & "-Widget-" & gblCodingEnvironment & ".exe""")
    Else
        Call writeRegistry(HKEY_CURRENT_USER, "SOFTWARE\Microsoft\Windows\CurrentVersion\Run", "Sun" & gblRichClientEnvironment & "Widget" & gblCodingEnvironment, vbNullString)
    End If
    ...
    If fFExists(gblSettingsFile) Then
        ...
        sPutINISetting "Software\Sun", "showTaskbar", gblShowTaskbar, gblSettingsFile
        sPutINISetting "Software\Sun", "showHelp", gblShowHelp, gblSettingsFile
        
        sPutINISetting "Software\Sun", "dpiAwareness", gblDpiAwareness, gblSettingsFile
        
        
        sPutINISetting "Software\Sun", "widgetSize", gblWidgetSize, gblSettingsFile
        sPutINISetting "Software\Sun", "scrollWheelDirection", gblScrollWheelDirection, gblSettingsFile
                
        sPutINISetting "Software\Sun", "widgetFunctions", gblWidgetFunctions, gblSettingsFile
        
        sPutINISetting "Software\Sun", "pointerAnimate", gblPointerAnimate, gblSettingsFile
        sPutINISetting "Software\Sun", "samplingInterval", gblSamplingInterval, gblSettingsFile
        
              
        sPutINISetting "Software\Sun", "aspectHidden", gblAspectHidden, gblSettingsFile
        sPutINISetting "Software\Sun", "widgetPosition", gblWidgetPosition, gblSettingsFile
        sPutINISetting "Software\Sun", "widgetLandscape", gblWidgetLandscape, gblSettingsFile
        sPutINISetting "Software\Sun", "widgetPortrait", gblWidgetPortrait, gblSettingsFile

        sPutINISetting "Software\Sun", "prefsFont", gblPrefsFont, gblSettingsFile
        sPutINISetting "Software\Sun", "widgetFont", gblWidgetFont, gblSettingsFile
        
        sPutINISetting "Software\Sun", "prefsFontSizeHighDPI", gblPrefsFontSizeHighDPI, gblSettingsFile
        sPutINISetting "Software\Sun", "prefsFontSizeLowDPI", gblPrefsFontSizeLowDPI, gblSettingsFile
        sPutINISetting "Software\Sun", "prefsFontItalics", gblPrefsFontItalics, gblSettingsFile
        sPutINISetting "Software\Sun", "prefsFontColour", gblPrefsFontColour, gblSettingsFile
        
        sPutINISetting "Software\Sun", "displayScreenFont", gblDisplayScreenFont, gblSettingsFile
        sPutINISetting "Software\Sun", "displayScreenFontSize", gblDisplayScreenFontSize, gblSettingsFile
        sPutINISetting "Software\Sun", "displayScreenFontItalics", gblDisplayScreenFontItalics, gblSettingsFile
        sPutINISetting "Software\Sun", "displayScreenFontColour", gblDisplayScreenFontColour, gblSettingsFile

        'save the values from the Windows Config Items
        sPutINISetting "Software\Sun", "windowLevel", gblWindowLevel, gblSettingsFile
        sPutINISetting "Software\Sun", "preventDragging", gblPreventDragging, gblSettingsFile
        
        sPutINISetting "Software\Sun", "opacity", gblOpacity, gblSettingsFile
        sPutINISetting "Software\Sun", "widgetHidden", gblWidgetHidden, gblSettingsFile
        sPutINISetting "Software\Sun", "hidingTime", gblHidingTime, gblSettingsFile
        sPutINISetting "Software\Sun", "ignoreMouse", gblIgnoreMouse, gblSettingsFile
        sPutINISetting "Software\Sun", "formVisible", gblFormVisible, gblSettingsFile
        sPutINISetting "Software\Sun", "multiMonitorResize", gblMultiMonitorResize, gblSettingsFile
        
        
        sPutINISetting "Software\Sun", "startup", gblStartup, gblSettingsFile

        sPutINISetting "Software\Sun", "enableSounds", gblEnableSounds, gblSettingsFile
'        sPutINISetting "Software\Sun", "enableTicks", gblEnableTicks, gblSettingsFile
'        sPutINISetting "Software\Sun", "enableChimes", gblEnableChimes, gblSettingsFile
'        sPutINISetting "Software\Sun", "enableAlarms", gblEnableAlarms, gblSettingsFile
'        sPutINISetting "Software\Sun", "volumeBoost", gblVolumeBoost, gblSettingsFile
        
        sPutINISetting "Software\Sun", "lastSelectedTab", gblLastSelectedTab, gblSettingsFile
        
        sPutINISetting "Software\Sun", "debug", gblDebug, gblSettingsFile
        sPutINISetting "Software\Sun", "dblClickCommand", gblDblClickCommand, gblSettingsFile
        sPutINISetting "Software\Sun", "openFile", gblOpenFile, gblSettingsFile
        sPutINISetting "Software\Sun", "defaultVB6Editor", gblDefaultVB6Editor, gblSettingsFile
        sPutINISetting "Software\Sun", "defaultTBEditor", gblDefaultTBEditor, gblSettingsFile
        
        sPutINISetting "Software\Sun", "widgetHighDpiXPos", gblWidgetHighDpiXPos, gblSettingsFile
        sPutINISetting "Software\Sun", "widgetHighDpiYPos", gblWidgetHighDpiYPos, gblSettingsFile
        
        sPutINISetting "Software\Sun", "widgetLowDpiXPos", gblWidgetLowDpiXPos, gblSettingsFile
        sPutINISetting "Software\Sun", "widgetLowDpiYPos", gblWidgetLowDpiYPos, gblSettingsFile
...
Private Sub btnDisplayScreenFont_Click()
    ...
    If gblSunWidgetAvailable = True Then
        fMain.SunForm.Widgets("lblTerminalText").Widget.FontSize = gblDisplayScreenFontSize
        fMain.SunForm.Widgets("lblTerminalText").Widget.FontName = gblDisplayScreenFont
    End If
...
Private Sub adjustPrefsControls(Optional ByVal restartState As Boolean)
    ...
    lblGitHub.Caption = "You can find the code for the Sun Widget on github, visit by double-clicking this link https://github.com/yereverluvinunclebert/Sun-" & gblRichClientEnvironment & "-Widget-" & gblCodingEnvironment
...
Private Sub sliSkewDegrees_Change()
    ...
    ' the widget rotation is modified in W_MouseWheel in cwSun
    ...
    If pvtAllowSkewChangeFlg = True Then
        SunWidget.SkewDegrees = sliSkewDegrees.Value
    End If
...
Private Sub lblGitHub_dblClick()
    ...
    If answer = vbYes Then
        Call ShellExecute(Me.hWnd, "Open", "https://github.com/yereverluvinunclebert/Sun-" & gblRichClientEnvironment & "-Widget-" & gblCodingEnvironment, vbNullString, App.Path, 1)
    End If
...
Public Sub sliWidgetSize_Change()
    ...
    ' the widget size is modified in W_MouseWheel in cwSun
...
widgetSizeGet_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in Property WidgetSize of Class Module cwSun"
End Property
...
'    widgetPrefs.sliAnimationInterval.BackColor = RGB(redC, greenC, blueC)
    ...
    sPutINISetting "Software\Sun", "skinTheme", gblSkinTheme, gblSettingsFile
