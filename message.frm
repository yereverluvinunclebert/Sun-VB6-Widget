...
Private Sub Form_Activate()
   ...
   On Error GoTo Form_Activate_Error
    ...
    gblMessageAHeightTwips = fGetINISetting("Software\Sun", "messageAHeightTwips", gblSettingsFile)
    gblMessageAWidthTwips = fGetINISetting("Software\Sun", "messageAWidthTwips ", gblSettingsFile)
...
Private Sub Form_Resize()
    ...
    sPutINISetting "Software\Sun", "messageAHeightTwips", gblMessageAHeightTwips, gblSettingsFile
    sPutINISetting "Software\Sun", "messageAWidthTwips", gblMessageAWidthTwips, gblSettingsFile
...
Public Property Let propTitle(ByVal newValue As String)
   On Error GoTo propTitle_Error
    ...
    If mPropTitle = "" Then
        Me.Caption = "Sun-" & gblRichClientEnvironment & "-Widget-" & gblCodingEnvironment & " Message."
    Else
